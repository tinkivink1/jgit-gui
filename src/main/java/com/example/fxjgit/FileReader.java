...
public class FileReader {
    public static List<String> read(File file) throws IOException, InvalidFormatException {
    ...
    private static List<String> readDocx(File file) throws IOException, InvalidFormatException {
